...
const Home = () => {
  return (
    <div className="h-screen bg-zinc-950 flex items-center justify-center text-white">
      <div className="border-1 border-zinc-800 rounded-md flex gap-10 justify-center items-center flex-col p-2">
        ...
        <div className="flex gap-5">
          ...
          <Link className="bg-amber-500 rounded-tl-none rounded-2xl p-2 text-black" to="/djppclubdownloader">Djppclub.in</Link>
        </div>
      </div>
    </div>
  );
